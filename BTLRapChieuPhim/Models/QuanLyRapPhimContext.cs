...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaDg).HasName("PK__DanhGia__272586600EFB1A4C");
        ...
        {
            entity.HasKey(e => e.MaDa).HasName("PK__DoAn__2725867A25F3BC11");
        ...
        {
            entity.HasKey(e => e.MaGxp).HasName("PK__GheXemPh__3CD3447881FE7106");
        ...
        {
            entity.HasKey(e => e.MaHat).HasName("PK__HinhAnhT__3C938F6EA5EF4095");
        ...
        {
            entity.HasKey(e => e.MaHd).HasName("PK__HoaDon__2725A6E0D1E7342E");
        ...
        {
            entity.HasKey(e => e.MaKh).HasName("PK__KhachHan__2725CF1ED22550A2");
        ...
        {
            entity.HasKey(e => e.MaKm).HasName("PK__KhuyenMa__2725CF155B4A4209");
        ...
        {
            entity.HasKey(e => e.MaLc).HasName("PK__LichChie__2725C76258C50E58");
        ...
        {
            entity.HasKey(e => e.MaPhim).HasName("PK__Phim__4AC03DE36B6DC0E9");
        ...
        {
            entity.HasKey(e => e.MaPc).HasName("PK__PhongChi__2725E7E5EAD6CECA");
        ...
        {
            entity.HasKey(e => e.MaQl).HasName("PK__QuanLy__2725F85221AFEF84");
        ...
        {
            entity.HasKey(e => e.MaRp).HasName("PK__RapPhim__2725F7BFED7866D8");
        ...
        {
            entity.HasKey(e => e.MaTk).HasName("PK__TaiKhoan__272500708A5B762B");
        ...
        {
            entity.HasKey(e => e.MaTt).HasName("PK__ThanhToa__27250079264D3E32");
        ...
        {
            entity.HasKey(e => e.MaTl).HasName("PK__TheLoai__272500716D138AB0");
        ...
        {
            entity.HasKey(e => e.MaVxp).HasName("PK__VeXemPhi__31CE4CB2342249BF");
